    ...
    <form className="space-y-4 sm:space-y-5" onSubmit={form.handleSubmit(onSubmit)}>
      ...
      <div className="space-y-2">
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                ...
                !form.watch("joining_date") && "text-gray-500 dark:text-gray-400"
              )}
            >
          ...
          <PopoverContent 
            className="w-auto p-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-xl z-50 rounded-lg" 
            align="start"
          >
            <Calendar
              mode="single"
