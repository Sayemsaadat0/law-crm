    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-white dark:has-data-[variant=inset]:bg-gray-950 flex min-h-svh w-full",
            className
          )}
          {...props}
        >
...
function Sidebar({
  ...
  return (
    <div
      className="group peer text-gray-900 dark:text-gray-100 hidden md:block"
      data-state={state}
    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            "bg-white dark:bg-gray-950 group-data-[variant=floating]:border-gray-200 dark:group-data-[variant=floating]:border-gray-800 flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm",
            className
          )}
        >
          {children}
