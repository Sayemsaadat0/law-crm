            ...
            <Tabs defaultValue="profile" className="w-full">
              ...
              <div className="mb-6">
                <TabsList className="inline-flex bg-transparent border-b border-gray-200 p-0 h-auto gap-0">
                  <TabsTrigger 
                    value="profile"
                    className="px-4 py-3 text-sm font-medium text-gray-600 border-b-2 border-transparent rounded-none data-[state=active]:text-primary-green data-[state=active]:border-primary-green data-[state=active]:bg-transparent hover:text-gray-900 transition-colors"
                  >
                    Profile
                  </TabsTrigger>
                  <TabsTrigger 
